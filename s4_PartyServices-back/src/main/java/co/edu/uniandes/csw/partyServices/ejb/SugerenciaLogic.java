...
public class SugerenciaLogic {
     ...
     * 
     * @param tematicasId. ID de la temática la cual será madre de la nueva sugerenica.
     * @param sugerenciaEntity La entidad que representa la sugerencia a persistir.
     * @return La entidad de la sugerencia luego de persistirla, con un ID asignado.
    ...
    /**
     * Obtiene la lista de los registros de Sugerencia que pertenecen a una Temática.
     *
     * @param tematicasId id de la temática de la cual hacen parte las sugerencias.
     ...
     * @return Instancia de SugerenciaEntity con los datos de la sugerencia consultada.
     *
     */
    public SugerenciaEntity getSugerencia(Long tematicasId, Long sugerenciasId) {
        LOGGER.log(Level.INFO, "Inicia proceso de consultar la sugerencia con id = {0} de la temática con id = " + tematicasId, sugerenciasId);
    ...
    public SugerenciaEntity updateSugerencia(Long tematicasId, SugerenciaEntity sugerenciaEntity) throws BusinessLogicException{
        ...
        LOGGER.log(Level.INFO, "Termina proceso de actualizar la sugerencia con id = {0} de la temática con id = " + tematicasId, sugerenciaEntity.getId());
        return sugerenciaEntity;
    }
     ...
     * @throws BusinessLogicException si la sugerencia no está asociada a la temática.
     */
    public void deleteSugerencia(Long tematicasId, Long sugerenciasId) throws BusinessLogicException{
       LOGGER.log(Level.INFO, "Inicia proceso de borrar la sugerencia con id = {0} de la temática con id = " + tematicasId, sugerenciasId);
        ...
        LOGGER.log(Level.INFO, "Termina proceso de borrar la sugerencia con id = {0} de la temática con id = " + tematicasId, sugerenciasId);
    }
}
