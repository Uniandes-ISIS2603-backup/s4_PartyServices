...
public class SugerenciaClienteResource {
    ...
    @Inject
    private ClienteSugerenciaLogic sugerenciaClienteLogic; //Variable para acceder a la lógica de la aplicación. Es una inyección de dependencias.
    ...
    public ClienteDetailDTO getCliente(@PathParam("tematicasId") Long tematicasId, @PathParam("sugerenciasId") Long sugerenciasId) {
        ...
        if (clienteEntity == null) {
            throw new WebApplicationException("El recurso/tematicas/" + tematicasId + "/sugerencias/" + sugerenciasId + "/clienteno existe.", 404);
        }
    ...
    public ClienteDetailDTO replaceCliente(@PathParam("tematicasId") Long tematicasId, @PathParam("sugerenciasId") Long sugerenciasId, @PathParam("clientesId") Long clientesId) {
        ...
        LOGGER.log(Level.INFO, "SugerenciaClienteResource replacecliente: output: {0}", clienteDetailDTO.toString());
        return clienteDetailDTO;
    }*/
     ...
     * @param tematicasId El ID de la temática de la cual se le agrega la
     * sugerencia.
     * @throws BusinessLogicException Error de lógica que se genera cuando la
     * sugerencia no tiene cliente.
     */
    /*@DELETE
    public void removeCliente(@PathParam("tematicasId") Long tematicasId, @PathParam("sugerenciasId") Long sugerenciasId) throws BusinessLogicException {
        LOGGER.log(Level.INFO, "SugerenciaClienteResource removeCliente: input: tematicasId: {0}, sugerenciasId{1}", new Object[]{tematicasId, sugerenciasId});
