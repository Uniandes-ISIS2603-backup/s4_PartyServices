...
public class EventoProductosResource {
    ...
    /**
     * Guarda un libro dentro de una servicio con la informacion que recibe el
     * la URL. Se devuelve el libro que se guarda en la servicio.
     *
     * @param serviciosId Identificador de la servicio que se esta
     * actualizando. Este debe ser una cadena de dígitos.
     * @param proveedoresId Identificador del libro que se desea guardar. Este debe
     * ser una cadena de dígitos.
     * @return JSON {@link ProveedorDTO} - El libro guardado en la servicio.
    ...
    /**
     * Busca y devuelve todos los libros que existen en la servicio.
     *
     * @param serviciosId Identificador de la servicio que se esta buscando.
     * Este debe ser una cadena de dígitos.
     * @return JSONArray {@link ProveedorDetailDTO} - Los libros encontrados en la
    ...
    /**
     * Busca el libro con el id asociado dentro de la servicio con id asociado.
     *
     * @param serviciosId Identificador de la servicio que se esta buscando.
     * Este debe ser una cadena de dígitos.
     * @param proveedoresId Identificador del libro que se esta buscando. Este debe
     * ser una cadena de dígitos.
     * @return JSON {@link ProveedorDetailDTO} - El libro buscado
     * @throws WebApplicationException {@link WebApplicationExceptionMapper} -
     * Error de lógica que se genera cuando no se encuentra el libro.
     ...
     * @param proveedores JSONArray {@link ProveedorDTO} El arreglo de libros nuevo para la
     * servicio.
     * @return JSON {@link ProveedorDTO} - El arreglo de libros guardado en la
     * servicio.
     * @throws WebApplicationException {@link WebApplicationExceptionMapper} -
     * Error de lógica que se genera cuando no se encuentra el libro.
     */
